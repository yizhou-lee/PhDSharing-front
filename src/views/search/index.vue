...
export default {
  ...
  data() {
    return {
      searchInput: '',
      searchWeb: 'https://scholar.google.com/scholar?hl=en&as_sdt=0%2C5&q=',
      logo: require('@/assets/image/logo1.png')
    }
  },
  methods: {
    handleSearch() {
      window.open(this.searchWeb + this.searchInput)
    }
  }
}
</script>
...
.search_input .el-input--medium .el-input__inner {
  height: 50px;
  line-height: 50px;
}
</style>
